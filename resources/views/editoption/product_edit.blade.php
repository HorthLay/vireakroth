...
<div class="container">
    ...
    <main>
        ...
        <div class="recent-orders p-4" style="background: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
            ...
            <form method="POST" action="{{ route('products.update',$product->id) }}" enctype="multipart/form-data" style="max-width: 600px; margin-top: 10px;">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="productName" name="price" value="{{ $product->price }}" class="form-control" 
                           placeholder="Enter category name" required 
                           style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #ddd; margin-top: 5px;">
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="productName" name="stock" value="{{ $product->stock }}" class="form-control" 
                           placeholder="Enter category name" required 
                           style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #ddd; margin-top: 5px;">
                </div>
               ...
               <div class="form-group mb-3">
                ...
                <input type="text" id="productName" name="discount" value="{{ $product->discount }}" class="form-control" 
                       placeholder="Enter category name" required 
                       style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #ddd; margin-top: 5px;">
            </div>
                ...
                <div class="form-group mb-3">
                    ...
                    @if($product->image)
                        <img src="{{ asset('products/' . $product->image) }}" alt="Category Image" style="max-width: 100px; display: block; margin-top: 5px;">
                    @else
                ...
                <!-- Image Upload Input -->
                <div class="form-group mb-3">
                    <label for="categoryImage" class="form-label" style="font-weight: 600;">Upload New Product Image</label>
