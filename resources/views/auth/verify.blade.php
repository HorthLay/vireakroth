    ...
    <form method="POST" action="{{ route('verification.resend') }}">
        ...
        <button type="submit" 
                style="
                    ...
                    mso-text-raise: 5px;
                    padding: 0 23px;
                    background-color: #0000FF; /* Update to your preferred button color */
                    color: #FFFFFF;
                    border: none;
                    font-family: 'Sofia Sans', BlinkMacSystemFont, 'Segoe UI', 'Helvetica Neue', Arial, sans-serif;
                    font-weight: 700;
                    font-size: 16px;
                    text-transform: none;
                    letter-spacing: -0.2px;
                    border-radius: 4px; /* Optional: Add a rounded edge */
                    cursor: pointer;
                ">
            Confirm
        </button>
