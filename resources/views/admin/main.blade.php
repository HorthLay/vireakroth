    ...
    <div class="analyse">
        <div class="sales">
            <div class="status">
                ...
                <div class="progresss">
                    ...
                    <lord-icon src="https://cdn.lordicon.com/ljgptdru.json" trigger="in" delay="400" state="in-reveal"
        ...
        <div class="visits">
            <div class="status">
                ...
                <div class="progresss">
                    ...
                    <lord-icon src="https://cdn.lordicon.com/dznelzdk.json" trigger="in" delay="400"
        ...
        <div class="searches">
            <div class="status">
                ...
                <div class="progresss">
                    <lord-icon src="https://cdn.lordicon.com/hnqamtrw.json" trigger="in" delay="400"
                        state="in-reveal" style="width:80px;height:80px">
                    </lord-icon>
                </div>
            </div>
            ...
            <tbody>
                ...
                @foreach ($recentOrders as $order_number => $group)
                    <tr style="background-color: {{ $group->first()->viewed ? 'transparent' : '#ffeb3b' }};">
                        ...
                        <td
                            style="color:
                            {{ $group->first()->status == 'success'
                                ? 'green'
                                : ($group->first()->status == 'pending'
                                    ? 'yellow'
                                    : ($group->first()->status == 'canceled'
                                        ? 'red'
                                        : 'black')) }};">
