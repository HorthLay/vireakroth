                                    ...
                                    <form action="{{ url('/update_order_status', $order->id) }}" method="POST">
                                        ...
                                        <select name="status" class="form-control" style="font-weight: bold;">
                                            <option value="pending" {{ $order->status == 'pending' ? 'selected' : '' }}
                                                style="color: orange;">🕒 Pending</option>
                                            <option value="success" {{ $order->status == 'success' ? 'selected' : '' }}
                                                style="color: green;">✅ Success</option>
                                            <option value="canceled"
                                                {{ $order->status == 'canceled' ? 'selected' : '' }}
                                                style="color: red;">❌ Canceled</option>
                                        </select>
                                        <button type="submit"
                                            style="border-radius: 10%; background-color: green; color: white; padding: 5px; cursor: pointer;"
