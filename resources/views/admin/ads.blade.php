...
<div class="container">
    ...
    <main>
        ...
        <div class="analyse">
            ...
            <div class="sales">
                <div class="status">
                    <div class="info">
                        <a id="createCategoryBtn" class="btn btn-primary" style="text-decoration: none;background-color: #007bff;padding: 10px 20px;border-radius: 5px;color: #fff;">Add Ads</a>
                    </div>
                    <div class="progresss">
                       ...
                       <td>{{ $ad->cta_url }}</td>
                        <td>
                            <div class="image-wrapper">
                                <img src="{{ asset('ads/'.$ad->image) }}" alt="" style="width: 200px; height: 100px;">
                            </div>
                        </td>
                        <td>
 ...
 <div id="addProductModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Add Ads</h2>
        <form id="addProductForm" action="{{ url('/addads') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div>
