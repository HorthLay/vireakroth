<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        $('#qrCodeModal').on('shown.bs.modal', function() {
            const md5Value = individual?.data
            ?.md5; // Replace with actual md5 generation logic if needed
            startQrCodeScanner(md5Value,
            orderNumber); // Use the orderNumber variable defined at the top
        });
        ...
        const fetchTransactionStatus = (md5, orderNumber) => {
            const token =
                'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7ImlkIjoiMzYyZTU0Y2RmNDk2NDUzNSJ9LCJpYXQiOjE3NDE3ODczNTYsImV4cCI6MTc0OTU2MzM1Nn0.Au8fr_r6pZJG4CuTXbFi-YsYSjJWe7TRZ38IBJzfFYo'; // Replace with your actual token
