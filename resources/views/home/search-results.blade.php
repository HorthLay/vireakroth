                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="{{ url('/') }}" class="logo">
                            <img src="{{ asset('pic/vireakroth.png') }}" alt="" style="width: 50px;"> </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 search-input">
                    <form id="search" action="{{ route('item.search') }}" method="GET" class="input-group">
                        <input type="text" class="form-control" placeholder="Search for products..." id="searchText"
                ...
                @if ($products->isEmpty())
                    <div class="col-12 text-center">
                        <div class="no-items-found">
                            ...
                            <h4 class="text-muted">Sorry, no products found.</h4>
                            <p class="text-secondary">Try searching for something else or check back later.</p>
                        </div>
                    </div>
                @else
                    @foreach ($products as $product)
